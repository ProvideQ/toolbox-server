...
import static edu.kit.provideq.toolbox.mip.MipConfiguration.MIP;
...
class MipSolversTest {
  ...
  Stream<Arguments> provideArguments() {
    var problemManager = problemManagerProvider.findProblemManagerForType(MIP).get();
