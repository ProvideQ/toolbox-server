...
class MaterialSimulationSolversTest {
  @Autowired
  ...
  void testMaterialSimulationSolver(ProblemSolver<String, String> solver, String input) {
    var problem = ApiTestHelper.createProblem(client, solver, input, MATERIAL_SIMULATION);
