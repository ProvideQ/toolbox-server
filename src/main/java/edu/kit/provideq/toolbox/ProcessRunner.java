...
public class ProcessRunner {
    ...
    public ProcessResult run(ProblemType problemType, long solutionId, String problemData) {
        ...
        try {
            ...
            return new ProcessResult(
                    false,
                    "Error: The problem data couldn't be written to %s:%n%s".formatted(normalizedProblemFilePath, e.getMessage())
            );
        }
        ...
        try {
            ...
            return new ProcessResult(
                    false,
                    "Error: The problem data couldn't be read from %s:%n%s".formatted(normalizedProblemFilePath, e.getMessage())
            );
        }
